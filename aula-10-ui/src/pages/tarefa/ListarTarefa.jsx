...
const initialRows = [
  createData(1, 'Tarefa 1', 'Atividade Prática 1', '2022-01-01', '2022-01-02', 'Concluída', 'Recurso 1'),
  createData(2, 'Tarefa 2', 'Atividade Prática 2', '2022-01-03', '2022-01-04', 'Em Andamento', 'Recurso 2'),
  createData(3, 'Tarefa 3', 'Exercícios', '2022-01-04', '2022-01-05', 'Em Andamento', 'Recurso 3'),
  createData(4, 'Tarefa 4', 'Revisão 1', '2022-01-05', '2022-01-06', 'Em Andamento', 'Recurso 4'),
  createData(6, 'Tarefa 6', 'Revisão 2', '2022-01-07', '2022-01-08', 'Aguardando', 'Recurso 6'),
];
...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        <CardHeader
          title="Tarefas"
          subheader="Insira os trabalhos desse trimestre"
        /> 
        <CardContent>
